...
public class BackgroundSystem : MonoBehaviour
{
    ...
    /*
    //Nome de todas as artes no modo cl�ssico de jogo:

    Arte da Capa do Game FHD_V2.1 - c�u mais forte-FHD
